...
share.WoodCProdMo         = 0; % TTR Made it a shared variable to have the output
share.TotPsn              = 0;
...
elseif POOLS == 2           % TTR
  ...
  share.PlantCfast  = 560;  % TTR Good run from Richardson et al. (2013)
  share.PlantCslow  = 470;  % TTR Good run form Richardson et al. (2013)
